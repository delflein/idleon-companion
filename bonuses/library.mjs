...
import { LIBRARY_CHECKOUT_TIME_BASE_SECONDS, LIBRARY_CHECKOUT_TIME_HOURS_MULTIPLIER, LIBRARY_CHECKOUT_BOOKCOUNT_EXPONENT, LIBRARY_CHECKOUT_BOOKCOUNT_COEFFICIENT } from "../gamedata-w3-library.mjs";
