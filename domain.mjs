...
import { OWL_UPGRADES } from "./gamedata-owl.mjs";
...
import { BUBBLE_TABLE } from "./gamedata-w2-bubbles.mjs";
import { VIAL_INFO } from "./gamedata-w2-vials.mjs";
import { CAULDRON_NAMES as CAULD_NAMES, LIQUID_NAMES, CAULDRON_P2W_MAX_LEVELS } from "./gamedata-w2-cauldron.mjs";
import { POPPY_UPGRADES, TAR_PIT_UPGRADES, SHINY_MULTI_TIERS, RESET_SPIRAL } from "./gamedata-w2-fishing.mjs";
import { KILLROY_SHOP } from "./gamedata-w2-killroy.mjs";
import { ISLANDS } from "./gamedata-w2-islands.mjs";
import { NUMBER_2_LETTER } from "./gamedata.mjs";
import { TOWER_INFO } from "./gamedata-w3-towers.mjs";
import { REFINERY_SALTS, REFINERY_BAY_BASE_CYCLE_SECONDS, REFINERY_POWER_CAP_BY_RANK, SALT_LICK_UPGRADES } from "./gamedata-w3-refinery.mjs";
import { WORSHIP_TOTEMS } from "./gamedata-w3-worship.mjs";
import { ATOM_INFO } from "./gamedata-w3-atoms.mjs";
import { PRINTER_SLOT_UNLOCKS } from "./gamedata-w3-printer.mjs";
...
import { MEAL_INFO } from "./gamedata-w4-meals.mjs";
import { PET_UPGRADES } from "./gamedata-w4-breeding.mjs";
import { TERRITORY_PLAYABLE } from "./gamedata-w4-territory.mjs";
import { RIFT_TIERS, RIFT_TASK_TYPES, SKILL_MASTERY_RANK_THRESHOLDS, SKILL_MASTERY_UNLOCK_RIFT } from "./gamedata-w4-rift.mjs";
import { COOKING_MASTERY_CATEGORIES } from "./gamedata-w4-cooking.mjs";
...
import { SUPERBITS, superbitCost, FERTILIZER_UPGRADES, IMPORT_TOOLS, MUTANT_SPROUT_NAMES_INFERRED, maxSnailLV } from "./gamedata-w5-gaming.mjs";
import { GAMING_PALETTE } from "./gamedata-w5-palette.mjs";
import { GODS_INFO_FULL, DIV_STYLES } from "./gamedata-w5-divinity.mjs";
import { VILLAGERS, CAVERNS, cavernsOwned } from "./gamedata-w5-hole.mjs";
import { SLAB_ITEM_SORT_COUNT, SLAB_OF_LEGEND_THRESHOLDS, SLAB_ARTIFACT_BONUSES, SLAB_BONUSES } from "./gamedata-w5-slab.mjs";
...
import { SUMMON_UPGRADES, SUMMONING_STONES, summoningStoneEssenceMultiplier, SUMMON_ENDLESS_DIFFICULTY, SUMMON_ENDLESS_DIFFICULTY_TEXT } from "./gamedata-w6-summoning.mjs";
import { NINJA_UPGRADES, GEMSTONES, PRISTINE_CHARMS, JADE_EMPORIUM, gachaPristineRollsRemaining, gachaSymbolRollsRemaining } from "./gamedata-w6-sneaking.mjs";
import { EMPEROR_BON_WIRING, emperorBossHp, dailyEmperorTries, maxEmperorAttemptStackDisplayed, emperorAttemptsLeft } from "./gamedata-w6-emperor.mjs";
import { BEANSTALK_SLOTS, GOLDEN_FOODS, BEANSTALK_RANK_THRESHOLDS } from "./gamedata-w6-beanstalk.mjs";
...
import { LEGEND_TALENTS, legendPtsBonus, legendTalentMaxLv } from "./gamedata-w7-legend.mjs";
import { LEGEND_TALENT_COEFF } from "./gamedata.mjs";
import { ZENITH_MARKET, zenithMarketBonusValue } from "./gamedata-w7-zenith.mjs";
import { CORAL_KID, CORAL_REEF_BUILDINGS, DANCING_CORAL, coralKidUpgBonus } from "./gamedata-w7-coralreef.mjs";
import { CLAM_UPG, CLAM_JOB_REWARDS } from "./gamedata-w7-clamwork.mjs";
import { SPELUNK_CAVES, SPELUNK_SHOP, BIG_FISH, bigFishBon } from "./gamedata-w7-spelunking.mjs";
import { SUSHI_TYPES, SUSHI_ROG_FULL } from "./gamedata-w7-sushi.mjs";
import { MINEHEAD_SHOP } from "./gamedata-w7-minehead.mjs";
import { BUTTON_TASKS } from "./gamedata-w7-button.mjs";
import { GLIMBO_TRADES } from "./gamedata-w7-research.mjs";
